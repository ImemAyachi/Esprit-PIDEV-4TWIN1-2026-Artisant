    ...
    return (
        <DashboardLayout currentTab="Profile">
            <div className="font-outfit pb-20">
                ...
                <div className="bg-white border-b-8 border-brand-teal px-8 py-6 sticky top-0 z-30 shadow-sm flex flex-col md:flex-row justify-between items-center gap-4">
