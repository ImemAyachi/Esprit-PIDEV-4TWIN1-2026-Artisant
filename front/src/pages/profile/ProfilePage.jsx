...
const ProfilePage = () => {
  ...
  const ROLE_ICON = { SuperAdmin: '🛡️', Architecte: '🏛️', Ingenieur: '⚙️', Artisan: '🔨', Fournisseur: '🏭' };
      ...
      <div className="card">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px,1fr))', gap: '1rem' }}>
          {[
            ...
            { label: 'Ville',          value: user.location?.city || '—',      icon: '📍' },
            { label: 'Membre depuis',  value: user.createdAt ? new Date(user.createdAt).toLocaleDateString('fr-FR') : '—', icon: '📅' },
